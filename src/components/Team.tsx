...
const teamMembers = [
  { name: "Dr. James Mwangi", role: "Chief Psychiatrist", bio: "Over 15 years of experience in mental health treatment. Specializes in mood disorders and substance abuse recovery.", avatar: { image: "/images/staff .jpeg" } },
  { name: "Dr. Mary Wanjiku", role: "Clinical Psychologist", bio: "Expert in trauma therapy and cognitive behavioral therapy. Passionate about integrating faith and healing.", avatar: { image: "/images/staff 2.jpeg" } },
  { name: "Rev. Peter Kamau", role: "Chaplain & Counselor", bio: "Provides spiritual guidance and pastoral care. Trained in addiction counseling and grief therapy.", avatar: { initials: "PK" } },
  { name: "Sarah Njeri", role: "Licensed Therapist", bio: "Specializes in family therapy and group counseling. Dedicated to helping families heal together.", avatar: { image: "/images/rehab 1.jpeg" } },
  { name: "David Ochieng", role: "Addiction Counselor", bio: "Certified addiction specialist with personal recovery experience. Leads group therapy sessions.", avatar: { image: "/images/rehab 2.jpeg" } },
  { name: "Grace Mutua", role: "Psychiatric Nurse", bio: "Provides compassionate nursing care and medication management. Available 24/7 for patient support.", avatar: { image: "/images/rehab 3.jpeg" } },
];
